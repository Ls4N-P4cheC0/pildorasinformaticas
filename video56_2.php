...
<body>
<h1>PDO Eliminar registros en BBDD</h1>
<form name="form1" method="post" action="inc/video56-sub2.php">
  <table border="0" align="center">
    ...
    <tr>
      ...
      <td align="center"><input type="reset" name="Borrar" id="Borrar" value="Limpiar forma"></td>
    </tr>
  </table>
</form>
</body>
